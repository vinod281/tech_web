...
function Notification({ message, action}) {
  ...
  return (
    <>
      {show && (
        <div className="fixed flex items-center w-full max-w-sm p-4 mx-auto mt-4 bg-white rounded-lg shadow-lg bottom-4 right-4 sm:max-w-xs md:max-w-sm lg:max-w-md">
